...
export default function SignupPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center py-12 px-4 relative overflow-hidden">
      {/* Decorative Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-emerald-800/20 rounded-full blur-[120px] mix-blend-screen pointer-events-none"></div>
      ...
      <div className="w-full max-w-md z-10 animate-fade-in">
        ...
        <div className="glass-panel rounded-2xl p-8 md:p-10">
          <div className="mb-8">
            ...
            <p className="text-textSecondary">Initialize your predictive workspace.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="mb-5">
              <span className="block text-sm font-medium text-textSecondary mb-3">Account Type</span>
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-lg font-medium text-sm transition-all border ${
                      role === r
                        ...
                        : "bg-white/5 border-white/10 text-textMuted hover:border-white/20 hover:text-textSecondary"
                    }`}
                  >
                    {r}
                  </button>
          ...
          <div className="mt-8 pt-6 border-t border-white/10 text-center">
            <p className="text-sm text-textSecondary">
              Already a member?{" "}
              <Link href="/login" className="text-primary hover:text-emerald-400 font-medium transition-colors">
                Sign in instead
              </Link>
            </p>
          </div>
