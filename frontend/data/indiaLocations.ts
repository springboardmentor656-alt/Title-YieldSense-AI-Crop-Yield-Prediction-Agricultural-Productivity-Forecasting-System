// Reference data: Indian states, union territories, and their districts.
// File: frontend/data/indiaLocations.ts
//
// NOTE: District boundaries are periodically revised by state governments
// (new districts get carved out every few years). This reflects commonly
// recognized districts as of recent years — if a state announces new
// districts later, update its array here only; no other code needs to change.
...
export const DISTRICTS_BY_STATE: Record<string, string[]> = {
  ...
  "Arunachal Pradesh": ["Tawang", "West Kameng", "East Kameng", "Papum Pare", "Kurung Kumey", "Lower Subansiri", "Upper Subansiri", "West Siang", "East Siang", "Upper Siang", "Lower Dibang Valley", "Dibang Valley", "Anjaw", "Lohit", "Namsai", "Changlang", "Tirap", "Longding", "Kamle", "Siang", "Shi Yomi", "Kra Daadi", "Pakke Kessang", "Lepa Rada"],
